...
Script Usage:
    ...
    --style-image:          The image generated by neural_style_transfer.py
    --style-mask:           Original Image that was transformed by neural_style_transfer
    --target-mask:          New Image I want to transform
    --target-image-prefix:  Prefix for generated target images
    ...
    and target mask.
    ```
    python style_filter_generation.py --nlabels 4 
    --style-image results/starry_results/bridge_results/bridge_result_at_iteration_49.png
    --style-mask test_images/goldengate.jpg
    --target-mask test_images/profpic.jpg
    --target-image-prefix test_results/Me+Starry
    ```
